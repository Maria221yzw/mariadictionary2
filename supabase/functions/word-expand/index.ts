...
11. 【强制】suggestedTags 必须全部使用中文，严禁出现任何英文标签。优先从以下标准标签库中选取，若无合适项再自行创建中文标签：
    - 专业领域：医学术语、法律文书、金融经济、科技前沿、语言学、文学赏析、数字营销、商务英语、哲学思辨、历史文化、生态环境、心理学
    - 应用场景：学术写作、翻译练习、日常口语、专业课笔记、演讲汇报、三创赛路演、外教Office Hour
    - 语法功能：用于转折、用于总结、固定搭配、介词用法、高频学术词
    - 情感色彩：褒义、中性、贬义、极度委婉、正式语体
    - 来源：纽约时报、BBC新闻、学术论文、课堂笔记、英美剧集、专八真题
    禁止输出如 Medical、Literature、Academic、Formal 等英文标签，统一替换为对应中文大类。`;
